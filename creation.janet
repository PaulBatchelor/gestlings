...
# remove pages before weewiki dump, because these are
# procedurally generated
(defn uncreate []
  (ww-open "a.db")
  (ww-del-page "beginning")
  (ww-del-page "was")
  (ww-del-page "be")
  (ww-del-page "necessity")
  (ww-del-page "universe")
  (ww-del-page "inspiration")
  (ww-del-page "cavernius")
  (ww-del-page "springs")
  (ww-del-page "cauldronia")
  (ww-del-page "cauldron")
  (ww-close))
