  ...
  (each res reslist
    (cond
      ...
      (do
        ...
        (org (codeblock-string-v2 md (res "id")))))))
#+END_SRC
...
#+BEGIN_SRC janet
(defn codeblock-string-v2 [md id]
  ...
  (defn handle-seg [s]
    (cond
      # I think named codeblocks at the end of a string
      # appends another extra string. A bug.
      (nil? (s "str")) (pp s)
