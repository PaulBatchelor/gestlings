...
#+NAME: node
#+BEGIN_SRC lua
function Graph.Node:constant(val)
    self.data.val = val
    self.data.constant = true
end

function Graph.Node:isconstant()
...
#+NAME: node
#+BEGIN_SRC lua
function Graph.Node:label(label)
...
#+NAME: node
#+BEGIN_SRC lua
function Graph.Node:generator(g, f)
    return function(p)
...
#+NAME: node
#+BEGIN_SRC lua
function Graph.Node:last_child(lst)
        local g = self.data.g
...
#+NAME: node
#+BEGIN_SRC lua
function Graph.Node:first_child(lst)
