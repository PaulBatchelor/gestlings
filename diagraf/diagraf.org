...
function Graph:setters_to_first_getters(lst)
    ...
    for i = 1,#lst do
        ...
        if n.data.children ~= nil then
            ...
            print("setter id is " .. n.data.setter)
            print("input node id " .. nid)
            print("input node id from setter " .. setter.input)
            link_node = self.nodes[setter.input]
            print("link node " .. link_node.data.link)
