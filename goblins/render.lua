...
function goblin_render(name, dur)
    gestku = require("gestku/" .. name)

    os.execute("mkdir -p res/goblins")
    ...
    ffmpeg_cmd = {
        ...
        "-tune", "stillimage",
        "-c:a", "aac", "-b:a", "256k",
        "-pix_fmt", "yuv420p", "-shortest", "res/goblins/" .. name .. ".mp4"
    }

    imagemagick_cmd = {
        "convert", name .. ".pbm", "res/goblins/" .. name .. ".png"
    }

    os.execute(table.concat(ffmpeg_cmd, " "))
    os.execute(table.concat(imagemagick_cmd, " "))
    os.remove(name .. ".pbm")
    os.remove(name .. ".wav")
end

goblin_render("2023_01_23", 11)
mnoreset()
goblin_render("2023_01_24", 11)
mnoreset()
goblin_render("2023_01_25", 11)
mnoreset()
goblin_render("2023_01_26", 11)
mnoreset()
goblin_render("2023_01_27", 11)
mnoreset()
goblin_render("2023_01_28", 15)
mnoreset()
goblin_render("2023_01_29", 11)
