...
function draw_row(vocab, tile, idx, rowpos, row_width, zoom, symbol_width, squaresz, shape_width)
...
for idx, tile in pairs(tilemap) do
    ...
    if empty(tile.data) == false then
        draw_row(vocab, tile, idx, rowpos, row_width, zoom, symbol_width, squaresz, shape_width)
        rowpos = rowpos + 1
